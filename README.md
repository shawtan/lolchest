...
Live Site: [Chest Finder](chestfinder.me)
...
We published our web application on Heroku at [Chest Finder.](chestfinder.me) We chose Heroku because it is free and easy to deploy to. Heroku also makes it easy to scale up the application at a later date.
